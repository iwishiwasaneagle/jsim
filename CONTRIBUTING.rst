...
Welcome to ``jsim`` contributor's guide.
...
If you experience bugs or general issues with ``jsim``, please have a look
...
You can help improve ``jsim`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``jsim`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``jsim``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n jsim python=3 six virtualenv pytest pytest-cov
    conda activate jsim
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/jsim.git
    cd jsim
...
#. Install |pre-commit|_::
   ...
   ``jsim`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/jsim
.. _issue tracker: https://github.com/<USERNAME>/jsim/issues
.. <-- end -->
